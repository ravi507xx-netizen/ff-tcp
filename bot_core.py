                ...
                if data.hex().startswith("120000"):
                    ...
                    if response:
                        ...
                        if inPuTMsG.strip() == "/debug":
                            ...
                            debug_msg = f"[FF0000]✅ MK TCP BOT ONLINE! UID: {uid}"
                        ...
                        if inPuTMsG.startswith("/help"):
                            ...
                            if is_admin(uid):
                                message = f"""[C][B][2E8B57]MK TCP BOT
━━━━━━━━━━━━━━━━━
...
[00CED1]DEV: MK DEVELOPER"""
                            ...
                            try:
                                ...
                                fallback_msg = "[FF0000]MK TCP BOT online! Use /help"
                        ...
                        if inPuTMsG.startswith('/stop') and is_admin(uid):
                            ...
                            stop_msg = f"[FF0000]MK TCP BOT stopping..."
                            ...
                            try:
                                ...
                                if len(parts) >= 2:
                                    ...
                                    mute_msg = f"[FFB300]MK BOT muted {time_str}"
                                else:
                            ...
                            is_muted = False
                            mute_until = 0
                            unmute_msg = f"[00FF00]MK BOT unmuted"
...
async def MaiiiinE():
    ...
    Uid , Pw = '4269703514','1498F2106A460D3C52F5CADC6AFAC24E339187A869FB5EF1AB2B703F5A9707A3'
    ...
    os.system('clear')
    print(render('MK TCP BOT', colors=['white', 'green'], align='center'))
    print('')
    print(f" - MK TCP BOT STarTinG And OnLine on TarGet : {TarGeT} | BOT NAME : {acc_name}\n")
    print(f" - BoT sTaTus > GooD | OnLinE ! (:")    
    print(f" - DEV: MK DEVELOPER | Bot Uptime: {time.strftime('%H:%M:%S', time.gmtime(time.time() - bot_start_time))}")    
